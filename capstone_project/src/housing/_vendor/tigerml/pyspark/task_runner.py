...
from housing.pyspark.context import create_context
from housing.pyspark.tracking import start_experiment, tracker
...
def create_task_id(context):
    ...
    Parameters
    ----------
    context : housing.pyspark.context.Context
