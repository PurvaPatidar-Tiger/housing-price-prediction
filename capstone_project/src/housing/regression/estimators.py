...
.. code:: python
    ...
    from housing.regression import estimators
...
import housing.eda.analysis as ta_analysis

# List of estimators exposed by the module
__all__ = ["SKLStatsmodelOLS","CombinedAttributesAdder"]
...
class SKLStatsmodelOLS(BaseEstimator, RegressorMixin):
    ...
    --------
    >>> import numpy as np
    >>> from housing.regression.estimators import SKLStatsmodelOLS
