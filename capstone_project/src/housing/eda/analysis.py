...
def get_variable_summary(df):
    ...
    Examples
    --------
    >>> from .eda.analysis import get_variable_summary
    >>> import pandas as pd
...
def get_data_health_summary(df, return_plot=False):
    ...
    Examples
    --------
    >>> from housing.eda.analysis import get_data_health_summary
    >>> import pandas as pd
    >>> df = pd.read_csv("titatic.csv")
...
def get_missing_values_summary(df, return_plot=False):
    ...
    Examples
    --------
    >>> from housing.eda.analysis import get_missing_values_summary
    >>> import pandas as pd
    >>> df = pd.read_csv("titatic.csv")
...
def get_duplicate_columns(df):
    ...
    Examples
    --------
    >>> from housing.eda.analysis import get_duplicate_columns
    >>> import pandas as pd
    >>> df = pd.read_csv("titatic.csv")
...
def get_outliers(df):
    ...
    Examples
    --------
    >>> from housing.eda.analysis import get_outliers
    >>> import pandas as pd
    >>> df = pd.read_csv("titatic.csv")
...
def get_density_plots(df, cols=None):
    ...
    Examples
    --------
    >>> from housing.eda.analysis import get_density_plots
    >>> import pandas as pd
    >>> df = pd.read_csv("titatic.csv")
    >>> # get the density plots for each of the numerical columns from the input data.
...
def get_percentile_plots(df, cols=None):
    ...
    Examples
    --------
    >>> from housing.eda.analysis import get_percentile_plots
    >>> import pandas as pd
    >>> df = pd.read_csv("titatic.csv")
...
def get_frequency_plots(df, cols=None):
    ...
    Examples
    --------
    >>> from housing.eda.analysis import get_frequency_plots
    >>> import pandas as pd
    >>> df = pd.read_csv("titatic.csv")
    >>> # get bar-plots of frequency distribution for non-numeric variables in the dataset.
...
def get_correlation_table(df, x_cols=None, y_cols=None):
    ...
    Examples
    --------
    >>> from housing.eda.analysis import get_correlation_table
    >>> import pandas as pd
    >>> df = pd.read_csv("titatic.csv")
...
def get_bivariate_plots(df, x_cols=None, y_cols=None):
    ...
    Examples
    --------
    >>> from housing.eda.analysis import get_bivariate_plots
    >>> import pandas as pd
    >>> df = pd.read_csv("titatic.csv")
...
def get_target_correlation(df, y, x_cols=None):
    ...
    Examples
    --------
    >>> from housing.eda.analysis import get_target_correlation
    >>> import pandas as pd
    >>> df = pd.read_csv("titatic.csv")
    >>> target = df[['Survived']]
...
def get_feature_importances(df, y, x_cols=None):
    ...
    Examples
    --------
    >>> from housing.eda.analysis import get_feature_importances
    >>> import pandas as pd
    >>> df = pd.read_csv("titatic.csv")
    >>> target = df[['Survived']]
